...
do { 
    ...
    switch (opcion) {
        case 1:  try (ResultSet rs = stmt.executeQuery(selectAll)) {
            while (rs.next()) {
        ...
        case 2: System.out.println("Crear cliente: \n");
        ...
        System.out.println("se insertara los datos: Cedula: "+ prueba1.getCedula()+ " Nombre: "+ prueba1.getNombre());
        String obj1 = "INSERT INTO prueba (id, nombre) VALUES (" + prueba1.id + ", '" + prueba1.nombre + "')";
        stmt.executeUpdate(obj1);
        System.out.println("Objeto insertado en base de datos vuelve a iniciar el programa para ver los cambios");
        break;
        ...
        case 4:    try (ResultSet ids = stmt.executeQuery("Select id from prueba")) {
            while (ids.next()) {
